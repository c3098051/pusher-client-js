...
var _Pusher = __webpack_require__(39);

var _Pusher2 = _interopRequireDefault(_Pusher);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var p = new _Pusher2.default(null, {
  cluster: 'cluster',
  log: true
}); /*
     ...
     * @Last Modified time: 2018-02-28 23:11:12 
     */


p.subscribe('private-channel');
...
var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }(); /*
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      * @Last Modified by: Jeff Jung
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      * @Last Modified time: 2018-02-28 23:34:19
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      */
...
var _findLast2 = __webpack_require__(126);
...
var DEFAULT_URL = 'ws://localhost:8080/ws';
var HANDSHAKE = 'handshake';
var SUBSCRIBE = 'subscribe';
var UNSUBSCRIBE = 'unsubscribe';
var CLOSE = 'close';

var RECONNECT_TIMEOUT_DEFAULT = 2 * 1000;
var defaultConfig = {
...
var PusherSubscriber = function () {
  function PusherSubscriber(URL, config) {
    _classCallCheck(this, PusherSubscriber);
  ...
  _createClass(PusherSubscriber, [{
    key: 'newWebSocket',
    value: function newWebSocket() {
      this.ws = new WebSocket(this.URL + '?cluster=' + this.config.cluster);
      this.registerSocketListener();
    }
  }, {
    key: 'channel',
    value: function channel(chanName) {
      var channel = (0, _findLast3.default)(this.channels, function (c) {
        return c.channel === chanName;
      });
      if (channel) {
      ...
      // new channel
      var newChannel = new _Channel2.default(chanName);
      this.channels.push(newChannel);
      return newChannel;
    }
  }, {
    key: 'subscribe',
    value: function subscribe(chanName) {
      this.logger('subscribe, channel: ' + chanName);

      var channel = this.channel(chanName);
    ...
    key: 'unsubscribe',
    value: function unsubscribe(chanName) {
      this.logger('unsubscribe, channel: ' + chanName);

      // remove channel from channels
      this.channels = (0, _filter3.default)(this.channels, function (c) {
        return c.channel !== chanName;
      });
    ...
    key: 'registerSocketListener',
    value: function registerSocketListener() {
      var _this = this;
    ...
    value: function onMessage(e) {
      this.logger('on received message', e.data);
...
var createFind = __webpack_require__(127),
    findLastIndex = __webpack_require__(128);
 ...
 * @Last Modified by: Jeff Jung
 * @Last Modified time: 2018-02-28 23:25:40
 */
var Channel = function () {
  ...
  _createClass(Channel, [{
    ...
    key: 'onMessage',
    value: function onMessage(eventName, data) {
